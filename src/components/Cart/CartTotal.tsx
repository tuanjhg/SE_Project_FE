  ...
  return (
    <div className='w-full mt-2 md:mt-0 flex-1 rounded bg-cartItem rounded-t-[2rem] px-8 py-2 flex flex-col items-center justify-evenly'>
        <div className="w-full flex items-center justify-between">
            ...
            <p className="text-gray-400 text-base md:text-lg "> {cartTotal}<span className="text-sm text-red-600">vnd</span></p>
        </div>
        <div className="w-full flex items-center justify-between">
          <p className="text-gray-400 text-base md:text-lg ">Delivery</p>
          <p className="text-gray-400 text-base md:text-lg">-</p>
            <p className="text-gray-400 text-base md:text-lg ">{0.000}<span className="text-sm text-red-600">vnd</span>
            </p>
        </div>
        ...
        <p className="text-gray-50 text-base md:text-lg">-</p>
            <p className="text-gray-50 text-base md:text-lg "> {cartTotal}<span
                className="text-sm text-red-600">vnd</span></p>
        </div>
